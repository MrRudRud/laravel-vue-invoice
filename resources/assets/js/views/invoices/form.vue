            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <typeahead :url="customerURL" :initialize="form.customer" @input="onCustomer"></typeahead>
                ...
                <div class="col-6">
                    <div class="form-group">
                        <label>Number <small>Auto Generated</small></label>
                        <div class="form-control">{{form.number}}</div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group">
